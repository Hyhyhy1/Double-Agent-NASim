...
class ExplorerHostVector:
    ...
    def vectorize(cls, host, address_space_bounds, vector=None):
        if cls.address_space_bounds is None:
            cls._initialize(
                address_space_bounds, host.services, host.os
            )
    ...
    def copy(self):
        ...
        return ExplorerHostVector(vector_copy)
    ...
    def _update_vector_idxs(cls):
        ...
        cls.state_size = cls._service_start_idx + cls.num_services
    ...
    def _service_idx_slice(cls):
        return slice(cls._service_start_idx, cls.state_size)
    ...
    def __eq__(self, other):
        if self is other:
            return True
        if not isinstance(other, ExplorerHostVector):
            return False
